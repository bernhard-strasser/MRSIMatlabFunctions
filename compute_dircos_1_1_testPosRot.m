function [Phase_new Read_new PosVec_Out RotMat] = compute_dircos_1_1_testPosRot(Slice_new,Rot_angle_around_Slice_new,PosVec_In)
...
%if(Rot_angle_around_Slice_new ~= 0)
    ...
    PosVec_Out = Rot_mat_around_Slice_new * transpose(PosVec_In);
    RotMat = Rot_mat_around_Slice_new;
%     for i = 1:3

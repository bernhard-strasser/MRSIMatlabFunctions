function Statistics = read_and_plot_phasemaps_1_7(file_struct,plot_mode,Hamming,AllProbandsComparison_outdir)
%
...
Statistics = Compare_CSI_to_Images_1_6(file_struct,Hamming,AllProbandsComparison_outdir);

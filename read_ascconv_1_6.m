function [ParList,ascconv] = read_ascconv_1_6(file_path)
%
...
if(numel(strfind(file_path, '.dat')) > 0)
    ParList_Search =  { ...
    'lRxChannelConnected','BaseResolution', 'PhaseEncodingLines', 'FinalMatrixSizePhase', 'FinalMatrixSizeRead', 'sSliceArray.lSize', 'sSpecPara.lFinalMatrixSizeSlice', 'VectorSize', 'RemoveOversampling', 'AsymmetricEchoAllowed', ...
    ...
    ParList_Search =  { ...
    'lRxChannelConnected','BaseResolution', 'PhaseEncodingLines', 'FinalMatrixSizePhase', 'FinalMatrixSizeRead', 'sKSpace.lPartitions', 'sSpecPara.lFinalMatrixSizeSlice', 'VectorSize', 'RemoveOversampling', 'AsymmetricEchoAllowed', ...
    'sKSpace.ucMultiSliceMode', 'sSliceArray.asSlice[0].dPhaseFOV', 'sSliceArray.asSlice[0].dReadoutFOV', 'sSliceArray.asSlice[0].sPosition.dSag', 'sSliceArray.asSlice[0].sPosition.dCor', ...
    'sSliceArray.asSlice[0].sPosition.dTra'};
end
...
ParList_Assign =  { ...
'total_channel_no'   ,'ROW_raw'       , 'COL_raw'           , 'ROW'                 , 'COL'                , 'SLC'              , 'SLC_spectro', 'vecSize'   , 'RemoveOversampling', 'AsymmetricEcho'       , ...
...
ParList_Convert = { ...
'str2double'         ,'str2double'    , 'str2double'        , 'str2double'          , 'str2double'         , 'str2double'       , 'str2double', 'str2double', 'char'              , 'char'                 , ...
...
ParList.total_channel_no = numel(ParList.total_channel_no); %#ok<NODEF>

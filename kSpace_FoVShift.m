...
% Create a matrix with size [nChannel nx ny nSlice] which linearly increases in x or y direction by -i*m*2pi, m E {-nx/2,...nx/2-1}
...
Phase_y = repmat(reshape(Phase_y,[1 1 ny nSlice]), [nChannel 1 ny 1 nTime]);

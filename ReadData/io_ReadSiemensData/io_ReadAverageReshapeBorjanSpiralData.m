function [SpiralOut_xt,AdditionalOut] = io_ReadAverageReshapeBorjanSpiralData(SpiralDataFile,SpiralTrajectoryFile,Settings)
%
...
SpiralOut_xt.Par.dicom_flag = false;

...
MRStruct.Par.TrajPts = 2*(MRStruct.MapVBVDObj.NIdc-1);
...
MRStruct.Par.ADC_dt_ns = 2*MRStruct.Par.Dwelltimes(1).*MRStruct.Par.nTempIntsPerAngInt./MRStruct.Par.TrajPts;       
% Factor 2 (2*MRStruct.Par.Dwelltimes(1)) bc the Par.Dwelltimes is actually wrong, it needs to be doubled.

function [Noise_std,Signal_ApodSmooth,Signal_SubPeak,ExcludeSubregions_StartEndPoints] = noise_computation_new_1_0(Signal,NoiseRegion,ApodizeOrSmooth,ApodOrSmoothValue)
%
...
%% 1. Compute Local Std
    ...
    ExcludeSubregions_Logical = Noise_Subregions_Std > Noise_StdLocal + 1.6*std(Noise_Subregions_Std);   % logical array indexing excluded subregion; Exclude regions that deviate more than 1.5*std from the mean. 

function [SNR_mat,Shift_mat] = compute_SNR_matrix_1_2(csi_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir,NoiseRegion_CS, ...
...
for x = 1:ROW
	for y = 1:COL
        for z = 1:SLC
            ...
            [Noise,Signal_Baseline,Signal_SubBas,Noise_ExcludeSubregions_StartEndPoints] = noise_computation_new_1_1(spectrum,[NoiseRegion_SP(1),NoiseRegion_SP(2)],'Smooth');
...
%               whole_spectrum_zf_fig = figure('visible','off');
                ...
                plot(Plot_NoiseRegion_x,spectrum_real(NoiseRegion_SP_vec),'o','MarkerSize',5)
                hold on
    ...
    %             
                ...
                if(exist('out_dir','var'))
                    ...
                    saveas(NoiseBase_fig,sprintf('%s/x_%s_y_%s_z_%s_NoiseAndBaseline', out_dir_FailedOrWon,num2str(x),num2str(y),num2str(z)),'epsc2')
                    ...
                    saveas(NoiseSubBase_fig,sprintf('%s/x_%s_y_%s_z_%s_NoiseSubBas', out_dir_FailedOrWon,num2str(x),num2str(y),num2str(z)),'epsc2')                

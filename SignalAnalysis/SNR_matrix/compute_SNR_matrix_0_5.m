function SNR_mat = compute_SNR_matrix_0_5(CSI_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir)
%
...
out_dir_failed = [out_dir, '_failed'];
out_dir_succeeded = [out_dir, '_succeeded'];

function [SNR_mat,Shift_mat] = compute_SNR_matrix_0_x16(csi_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir,NoiseRegion_CS, ...
...
for z = 1:SLC
	for y = 1:COL
        for x = 1:ROW
            ...
            [Noise,Signal_Baseline,Signal_SubBas] = noise_computation_new_0_4(spectrum,[NoiseRegion_SP(1),NoiseRegion_SP(2)],'Apodize');
...
%              spectrum_zf_real,SeekNAA_PeakRegion_SP,Noise,'SNR_Criterion',{[SeekNAA_SNRthreshold,SeekNAA_BasisRegionWidth_SP,SeekNAA_BasisRegionPeakdistance_HiFi_SP, SeekNAA_BasisRegionPeakdistance_LoFi_SP]});
            ...
            [NoNAApeak_found,FoundNAAPeak_SP,FoundNAAPeak_SS,FoundNAA_Basis_SP,FoundNAA_Basis_SS,FoundNAA_MeanBasis_SS,SeekNAA_HiFiBasisRegion_SP,SeekNAA_LoFiBasisRegion_SP,SeekNAA_Polyfit,SeekNAA_SubBas] = seek_peak_0_6( ...
             spectrum_zf,SeekNAA_PeakRegion_SP,SeekNAA_InRealOrAbs,0,'SNR_Criterion',{{Noise,SeekNAA_SNRthreshold,SeekNAA_BasisRegionWidth_SP,SeekNAA_BasisRegionPeakdistance_HiFi_SP, SeekNAA_BasisRegionPeakdistance_LoFi_SP}});
...
%               whole_spectrum_zf_fig = figure;  
            ...
            plot(Plot_NoiseRegion_x,Signal_SubBas(NoiseRegion_SP_vec))
            set(gca,'XDir','reverse');

function [SNR_mat,Shift_mat] = compute_SNR_matrix_0_x12(csi_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir,quiet,Debug_Mode)
%
...
NoiseRegion_LoFi_CS = 5.0;   % LoFi region where to compute the standard deviation of the noise    6
NoiseRegion_HiFi_CS = 8.5;   % Same for HiFi                                                     7.5
Noise_polyfit_order = 3;        % The noise is often not along a flat line, but more or less linear dependent on chemical shift

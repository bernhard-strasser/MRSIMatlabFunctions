function read_and_plot_phasemaps_1_0(file_struct,plot_mode,pha_abs,Hamming)


% file_struct = struct('name', 'CSI', 'Image', 'Flip', 'Weighting', 'water_frequency', 'dwelltime', 'fredir_shift')

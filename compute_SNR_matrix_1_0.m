function [SNR_mat,Shift_mat] = compute_SNR_matrix_1_0(csi_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir,NoiseRegion_CS, ...
                               SeekNAA_PeakRegionWidth_IfWaterFound,SeekNAA_PeakRegionWidth_IfWaterNotFound,SeekNAA_BasisRegionPeakdistance_CS,SeekNAA_InRealOrAbs,quiet)
%
...
SeekWater_SNRthreshold = 25.0;                          % Threshold for SNR in order to consider peak as water peak
...
for z = 1:SLC
	for y = 1:COL
        for x = 1:ROW
            ...
            [Noise,Signal_Baseline,Signal_SubBas,Noise_ExcludeSubregions_StartEndPoints] = noise_computation_new_1_0(spectrum,[NoiseRegion_SP(1),NoiseRegion_SP(2)],'Apodize');
...
%              spectrum_zf_real,SeekNAA_PeakRegion_SP,Noise,'SNR_Criterion',{[SeekNAA_SNRthreshold,SeekNAA_BasisRegionWidth_SP,SeekNAA_BasisRegionPeakdistance_HiFi_SP, SeekNAA_BasisRegionPeakdistance_LoFi_SP]});
            ...
            [NoNAApeak_found,FoundNAAPeak_SP,FoundNAAPeak_SS,FoundNAA_Basis_SP,FoundNAA_Basis_SS,FoundNAA_MeanBasis_SS,SeekNAA_HiFiBasisRegion_SP,SeekNAA_LoFiBasisRegion_SP,SeekNAA_Polyfit,SeekNAA_SubBas] = seek_peak_1_0( ...

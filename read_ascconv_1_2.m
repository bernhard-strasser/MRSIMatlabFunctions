function [ParList,ascconv] = read_ascconv_1_2(file_path)
%
...
ParList_Search =  {'lRxChannelConnected','BaseResolution', 'PhaseEncodingLines', 'FinalMatrixSizePhase', 'FinalMatrixSizeRead', 'FinalMatrixSizeSlice', 'VectorSize', 'RemoveOversampling'};
% Name the structure entries of ParList like this:
ParList_Assign =  {'total_channel_no'   ,'ROW_raw'       , 'COL_raw'           , 'ROW'                 , 'COL'                , 'SLC'                 , 'vecSize'   , 'RemoveOversampling'};
...
ParList_Convert = {'str2double'         ,'str2double'    , 'str2double'        , 'str2double'          , 'str2double'         , 'str2double'          , 'str2double', 'char'              };

function [FID,Spectrum] = Simulate_FID_Spectra_1_1(omega,phase0,AcqDelay,T2,S_0,SNR,dwelltime,vecSize,SmoothFIDSpan)
...
FID = [t; S_0 * exp((omega - water_frequency*2*pi) * 1i*t).*exp(-t/T2)*exp(1i*deg2rad(phase0)) + Noise + 1i*Noise]; % Is real and imaginary noise uncorrelated?

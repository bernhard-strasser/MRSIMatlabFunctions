function [SNR_mat,Shift_mat] = compute_SNR_matrix_1_4(csi_mat_time,zerofilling,water_frequency,dwelltime,mask,out_dir,NoiseRegion_CS, ...
                               SeekNAA_PeakRegionWidth_IfWaterFound,SeekNAA_PeakRegionWidth_IfWaterNotFound,SeekNAA_BasisRegionPeakdistance_CS,Phantom_flag,SeekNAA_InRealOrAbs,quiet,printmap_flag)
%

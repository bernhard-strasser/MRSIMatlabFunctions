function Statistics = Compare_CSI_to_Images_1_5(file_struct,Hamming,AllProbandsComparison_outdir)
...
for read_index = 1:size(file_struct,2)  % CSI DATA = LARGE --> COMPUTATIONS FOR EACH FILE INDIVIDUALLY
   ...
   %% 0. DEFINITIONS, PREPARATIONS
    ...
    if(Phantom_flag)
        ...
        SubPhase = deg2rad(29.606495); %30.0035
    end   
...
%     end
    ...
    if(LCM_flag)
        if(Phantom_flag)
            ...
            SubPhaseFromCSI = 15.208848923326459;
        end

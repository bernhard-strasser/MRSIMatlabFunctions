function [ParList,ascconv] = read_ascconv_1_7(file_path)
%
...
if(numel(strfind(file_path, '.dat')) > 0)
    ParList_Search =  { ...
    'asCoilSelectMeas\[0\]\.asList\[\d+\]\.lRxChannelConnected',    'BaseResolution',                               'PhaseEncodingLines',                         'FinalMatrixSizePhase', ...
    'FinalMatrixSizeRead',                                          'sSliceArray\.lSize',                           'VectorSize',                                 'RemoveOversampling', ...
    'AsymmetricEchoAllowed',                                        'sKSpace\.ucMultiSliceMode',                    'sSliceArray\.asSlice\[0\]\.dPhaseFOV',       'sSliceArray\.asSlice\[0\]\.dReadoutFOV', ...
    'sSliceArray\.asSlice\[0\]\.sPosition\.dSag',                   'sSliceArray\.asSlice\[0\]\.sPosition\.dCor',   'sSliceArray\.asSlice\[0\]\.sPosition\.dTra'};
else
    ParList_Search =  { ...
    'asCoilSelectMeas\[0\]\.asList\[\d+\]\.lRxChannelConnected',    'BaseResolution',                               'PhaseEncodingLines',                         'FinalMatrixSizePhase', ...
    'FinalMatrixSizeRead',                                          'sKSpace\.lPartitions',                         'VectorSize',                                 'RemoveOversampling', ...
    'AsymmetricEchoAllowed',                                        'sKSpace\.ucMultiSliceMode',                    'sSliceArray\.asSlice\[0\]\.dPhaseFOV',       'sSliceArray\.asSlice\[0\]\.dReadoutFOV', ...
    'sSliceArray\.asSlice\[0\]\.sPosition\.dSag',                   'sSliceArray\.asSlice\[0\]\.sPosition\.dCor',   'sSliceArray\.asSlice\[0\]\.sPosition\.dTra'};
end
...
ParList_Assign =  { ...
'total_channel_no',                                                 'ROW_raw',                                       'COL_raw',                                   'ROW', ...
'COL',                                                              'SLC',                                           'vecSize',                                   'RemoveOversampling', ...
'AsymmetricEcho',                                                   'InterleavedAcquisition',                        'FoV_Phase',                                 'FoV_Read', ...
...
ParList_Convert = { ...
'str2double',                                                       'str2double',                                     'str2double',                               'str2double',...
'str2double',                                                       'str2double',                                     'str2double',                               'char', ...
'char',                                                             'char',                                           'str2double',                               'str2double', ...
